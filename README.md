...
`As house elf dobby, I mainly focused on the code structure and lead the overall functions in this project` | `As luna lovegood, I lead the main design of the project and graphics` | `As headmaster dumbledore, I managed the schedule and boundaries of this app`
